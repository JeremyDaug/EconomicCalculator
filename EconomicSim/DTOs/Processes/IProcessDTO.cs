...
namespace EconomicSim.DTOs.Processes
{
    ...
    public interface IProcessDTO
    {
        ...
        /// Input Products
        /// </summary>
        List<IProcessProductDTO> InputProducts { get; }

        /// <summary>
        /// Input Wants
        /// </summary>
        List<IProcessWantDTO> InputWants { get; }
        ...
        /// Capital Products.
        /// </summary>
        List<IProcessProductDTO> CapitalProducts { get; }

        /// <summary>
        /// Capital Wants (IE, non-consumable products with the proper want attached).
        /// </summary>
        List<IProcessWantDTO> CapitalWants { get; }
        ...
        /// Product Outputs.
        /// </summary>
        List<IProcessProductDTO> OutputProducts { get; set; }

        /// <summary>
        /// Want outputs of the process.
        /// </summary>
        List<IProcessWantDTO> OutputWants { get; set; }
