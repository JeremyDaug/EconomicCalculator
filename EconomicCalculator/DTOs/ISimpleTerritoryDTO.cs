...
namespace EconomicCalculator.DTOs
{
    /// <summary>
    ...
    public interface ISimpleTerritoryDTO
    {
        ...
        /// </summary>
        List<(string neighbor, decimal distance, TerritoryConnectionType conType)> Neighbors { get; }

        /// <summary>
        /// The Nodes within the territory and the depth at which it can be mined.
        /// -1 means inifinite size.
        /// </summary>
        List<(string resource, decimal stockpile, int depth)> Nodes { get; }
        
        /// <summary>
        /// The Resources available on the surface of the territory
        /// Amount of -1 means infinite.
        /// </summary>
        List<(string resource, decimal amount)> Resources { get; }
    }
}
