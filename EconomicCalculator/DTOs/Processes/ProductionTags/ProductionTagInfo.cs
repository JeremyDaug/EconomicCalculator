...
namespace EconomicCalculator.DTOs.Processes.ProductionTags
{
    public static class ProductionTagInfo
    {
        ...
        /// <returns></returns>
        public static bool ProcessProductIsValid(IProcessProduct product, ProcessSection placement)
        {
        ...
        /// <returns></returns>
        public static bool ProcesswantIsValid(IProcessWant want, ProcessSection placement)
        {
            var processed = new HashSet<ProductionTag>();
            var invalid = new HashSet<ProductionTag>();
