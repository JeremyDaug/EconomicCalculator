...
public class ProcessProductEditorViewModel : ViewModelBase
{
    
    private Window? _window;
    private IDataContext dc = DataContextFactory.GetDataContext;
    private ProcessProductModel _original;
    ...
    public ProcessProductEditorViewModel()
    {
        ...
        _original = new ProcessProductModel();
        _original.Part = ProcessPartTag.Input;
    }
    
    public ProcessProductEditorViewModel(Window window)
    {
        CommitPart = ReactiveCommand.Create(Commit);
        _window = window;
        ProductOptions = new ObservableCollection<string>(dc.Products.Keys);
    ...
    public ProcessProductEditorViewModel(ProcessPartTag part, Window win)
    {
        CommitPart = ReactiveCommand.Create(Commit);
        _window = win;
        ProductOptions = new ObservableCollection<string>(dc.Products.Keys);
    ...
    public ProcessProductEditorViewModel(ProcessProductModel old, Window win)
    {
        CommitPart = ReactiveCommand.Create(Commit);
        _window = win;
        ProductOptions = new ObservableCollection<string>(dc.Products.Keys);
    ...
    public ProcessProductModel? CompleteModel { get; set; }
}